...
mtext("Fig.1: Proportion of events with top 100 highest", outer=T)
```
...
mtext("Fig.2: Proportion of the totals of outcomes from all recent events recorded as from 2000", outer=T)
```
...
Looking into the other events, we can see the events with the greatest economic consequences (in terms of costs) are not necessarily the most lethal. Heat waves are a clear example. Hurricanes, on the other hand, cause more economic damages than fatalities. That is visible in the distributions of outcomes in the pie-charts in the figure 2.
